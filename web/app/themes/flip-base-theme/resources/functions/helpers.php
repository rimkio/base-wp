...
if ( ! function_exists( 'flip_base_svg_icon' ) ) {
	 ...
	 * @return mixed|string
	 */
	function flip_base_svg_icon( $icon ) {
...
if ( ! function_exists( 'flip_base_the_posts_navigation' ) ) {
	function flip_base_the_posts_navigation( $args = array(), $base = false, $query = false ) {
