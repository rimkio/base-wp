...
/* harmony import */ var _package__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./package */ "./resources/assets/js/package.js");
...
(function (w, $, wp) {
  ...
  var setValueCssIEGap = function setValueCssIEGap() {
    ...
    if ($('.wp-block-my-block-gap').length != 0) {
      $(".wp-block-my-block-gap").each(function (index) {
        var dataDF = $(this).data('size-default');
        var dataTablet = $(this).data('size-tablet');
        var dataMobile = $(this).data('size-mobile');
  ...
  $(function () {
    ...
    var socials = document.querySelectorAll('.wp-block-social-links a');
    socials.forEach(function (vl, key) {
      vl.target = "_blank";
    });
  }.bind(this)); // Browser load completed
...
(function (w, $) {
  ...
  var MobileToggleMenu = function MobileToggleMenu() {
    ...
    $('.main-menu').on('click', '.menu-item.menu-item-has-children', function (e) {
      //e.preventDefault();
      e.stopPropagation();
      if ($(e.target).is('a, a *')) return; //console.log($(this).parent('.sub-menu').length, this)
  ...
  $(document).on('nfFormReady', function () {}); // Browser load completed

  $(w).load(function () {});
  $(Ready);
}).bind(undefined)(window, jQuery);
...
module.exports = __webpack_require__(/*! ./resources/assets/js/functions.js */"./resources/assets/js/functions.js");
